...
* For high income, `weeks_worked_in_year` is very concentrated around 52 worked weeks (1st quartile, median and 3rd quartile are all 52 weeks). Or, from another angle, everything below 52 weeks is considered by the boxplot as an outlier. For low income, the 1st quartile worked 0 week, while the 3rd quartile worked 52 weeks, with the median number of worked weeks lying somewhere around 43 weeks.
* `wage_per_hour`, `capital_losses`, `dividends_from_stock`,`capital_gains` are all highly skewed to the right. We mitigate the skewness by log-transforming them.
