...
Prepare the design matrix and create cross-validation.
...
mod_spec_xgboost <- boost_tree(mode = "classification", trees = 20) %>%
  set_engine("C5.0")
...
* Retrain the best model using on whole dataset.
